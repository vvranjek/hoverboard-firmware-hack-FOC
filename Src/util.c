...
void standstillHold(void) {
    ...
    if (!rtP_Left.b_cruiseCtrlEna) {                                  // If Stanstill in NOT Active -> try Activation
      if (((input1[inIdx].cmd > 990 || input2[inIdx].cmd < -200) && speedAvgAbs < 30) // Check if Brake is pressed AND measured speed is small
      ...
      if (input1[inIdx].cmd < 900 && !cruiseCtrlAcv) { // Check if Brake is released AND Throttle is pressed AND no Cruise Control
